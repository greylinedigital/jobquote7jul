...
import { ChevronLeft, Send, Pencil, FileText, Plus, Trash2, Receipt, ChevronDown, ChevronUp, RefreshCw, CircleCheck as CheckCircle, Clock, Mail } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  ...
  actionsGrid: {
    gap: 16, // Increased gap between action buttons
